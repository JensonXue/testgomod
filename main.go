...
import (
	...
	//"github.com/JensonXue/testgomod/pkg/demox"

	// 2-2 引用包的路径，发现可以运行
	// github.com/JensonXue/testgomod 是项目名，go.mod 的名称，可以理解为当前项目的根目录
	// 因此 github.com/JensonXue/testgomod/pkg/demo1 就可以指向 demox 包
	// 之后下面就可以调用 demox 包
	...
	"fmt"
	"github.com/JensonXue/testgomod/pkg/demo1"
)
